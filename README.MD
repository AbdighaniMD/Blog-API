...
```bash
  git clone https://github.com/AbdighaniMD/Blog-API.git
```
...
##### baseURL = `https://github.com/AbdighaniMD/Blog-API.git`
...
```http
  GET /api/v1/posts/posts-dislikes/:id
```
...
| :--------------- | :------- | :------------- | :------- |
| `authentication` | `string` | Your token     | yes      |
| `id`             | `string` | ID of the categories | yes|
